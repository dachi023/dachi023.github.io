...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.fields.path'
  ...
  | 'childMarkdownRemark.fields.path'
...
type IndexPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'description' | 'title'>> }> };

type PostsPageQueryQueryVariables = Exact<{ [key: string]: never; }>;


type PostsPageQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'id' | 'rawMarkdownBody' | 'timeToRead'>
        & { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'path'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'description' | 'title'>> }
      ) }> }, readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'description' | 'title'>> }> };
...
type PostPageQueryQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'html' | 'timeToRead'>
    & { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'path'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'description' | 'title'>> }
  )>, readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'description'>> }> };
